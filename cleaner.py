...
def clean_data(df, numeric_strategy="ignore", non_numeric_strategy="ignore", logger=None):
    ...
    logger(f"##DEBUG amounts hmv: {list(df['price'].unique())}")
